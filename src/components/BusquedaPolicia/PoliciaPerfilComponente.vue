...
import Modal from '@/components/BusquedaPolicia/PoliciasMultasComponente.vue';
...
export default defineComponent({
    ...
    setup() {
        ...
        const policiaId = ref(parseInt(parseRouteParam(route.params.id) || '0'));
        const showModal = ref(false);

        const policiaDetails = computed<Policia>(() => {
            return store.infoPolicias.find(c => c.idPolicia === policiaId.value) || {
                idPolicia: 0,
                idCiudadano: 0,
                rango: '',
                numeroPlaca: '',
                ...
                <div class="ciudadano_perfil_usuario">
                    ...
                    <div class="ciudadano_perfil_usuario_derecha">
                        <div class="ciudadano_tarjeta">
                            <p>Nombre</p>
                            <p>{{ policiaDetails.ciudadano[0].nombre }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Apellidos</p>
                            <p>{{ policiaDetails.ciudadano[0].apellidos }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Genero</p>
                            <p>{{ policiaDetails.ciudadano[0].genero }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Nacionalidad</p>
                            <p>{{ policiaDetails.ciudadano[0].nacionalidad }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Fecha de nacimiento</p>
                            <p>{{ policiaDetails.ciudadano[0].fechaNacimiento }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>ID</p>
                            <p>{{ policiaDetails.idCiudadano }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Número de teléfono</p>
                            <p>{{ policiaDetails.ciudadano[0].numeroTelefono }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Número de cuenta</p>
                            <p>{{ policiaDetails.ciudadano[0].numeroCuentaBancaria }}</p>
                        </div>
                        <div class="ciudadano_tarjeta">
                            <p>Trabajo</p>
                            <p>{{ }}</p>
                ...
                <div class="ciudadano_perfil_otros">
                    <div class="ciudadano_perfil_otros_container">
                        <div class="ciudadano_perfil_notasdiv">
                            ...
                            <template
                                v-if="policiaDetails.ciudadano[0].multas && policiaDetails.ciudadano[0].multas.length > 0">
                                <div class="notas_container">
                                    <div v-for="multa in policiaDetails.ciudadano[0].multas" :key="multa.idMulta"
                    ...
                    <div class="ciudadano_perfil_otros_container">
                        <div class="ciudadano_perfil_notasdiv">
                            ...
                            <template
                                v-if="policiaDetails.ciudadano[0].vehiculos && policiaDetails.ciudadano[0].vehiculos.length > 0">
                                <div v-for="vehiculo in policiaDetails.ciudadano[0].vehiculos"
                                    :key="vehiculo.idVehiculo" class="tarjeta_otros">
