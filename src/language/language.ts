import VehiculoBusquedaComponente from "@/components/BusquedaVehiculo/VehiculoBusquedaComponente.vue";
...
export const messages = {
  en: {
    ...
    BotonesPrincipales: {
      ...
      deudores: "Debtors",
      gestionarAgentes: "Manage Agents",
      agentes: "Agents",
      vehiculos: "Vehicles",
      gestionRangos: "Manage Ranks",
      grafica: "Graph",
      gestionarEventos: "Manage Events",
      codigoPenal: "Penal Code",
      busquedaCaptura: "Search and Capture",
      eventos: "Events",
      perfil: "Profile",
      inicioSesion: "Login",
      cerrarSesion: "Logout",
      salirServicio: "End of Service",
    },
    ...
    EventoAyuntamiento: {
      Title: "There are no events available at this time.",
      Date: "Date: ",
    },
    ...
    PerfilCiudadano: {
      ...
      Select: "SELECT A CITIZEN TO LOAD THE INFORMATION",
      Name: "Name",
      Surname: "Surname",
      Gender: "Gender",
    ...
    PerfilPolicia: {
      Profile: "POLICE PROFILE",
      Select: "SELECT A POLICE TO LOAD THE INFORMATION",
      Name: "Name",
      Surname: "Surname",
      Gender: "Gender",
      Nationality: "Nationality",
    ...
    PerfilVehiculo: {
      ...
      Select: "SELECT A VEHICLE TO LOAD THE INFORMATION",
      Brand: "Brand",
      Model: "Model",
      Year: "Year",
      Color: "Color",
    ...
    LoginAyuntamiento: {
      ...
      Login: "Log in",
      Principal: "Back to the main page",
      Ayuntamiento: "Are you from the Town Hall?",
    },
  ...
  es: {
    ...
    BotonesPrincipales: {
      ...
      denuncias: "Denuncias",
      deudores: "Deudores",
      gestionarAgentes: "Gestionar Agentes",
      agentes: "Agentes",
      vehiculos: "Vehículos",
      gestionRangos: "Gestionar Rangos",
      grafica: "Gráfica",
      gestionarEventos: "Gestionar Eventos",
      codigoPenal: "Código Penal",
      busquedaCaptura: "Búsqueda y Captura",
      eventos: "Eventos",
      perfil: "Perfil",
    ...
    PerfilCiudadano: {
      Profile: "PERFIL DEL CIUDADANO",
      Select: "SELECCIONA UN CIUDADANO PARA CARGAR LA INFORMACIÓN",
      Name: "Nombre",
      Surname: "Apellidos",
      Gender: "Género",
      ...
      Work: "Trabajo",
      Captura: "EN BUSQUEDA Y CAPTURA",
      No: "No",
      Yes: "Sí",
      Peligroso: "Peligroso",
      Notas: "Notas",
      NoNotas: "NO HAY NOTAS REGISTRADAS",
      Multa: "MULTAS",
      AddMulta: "Añadir Multa",
    ...
    PerfilPolicia: {
      Profile: "PERFIL DEL POLICÍA",
      Select: "SELECCIONA UN POLICÍA PARA CARGAR LA INFORMACIÓN",
      Name: "Nombre",
      Surname: "Apellidos",
      Gender: "Género",
      Nationality: "Nacionalidad",
    ...
    PerfilVehiculo: {
      Profile: "DATOS DEL VEHÍCULO",
      Select: "SELECCIONA UN VEHÍCULO PARA CARGAR LA INFORMACIÓN",
      Brand: "Marca",
      Model: "Modelo",
      Year: "Año",
      Color: "Color",
    ...
    LoginAyuntamiento: {
      ...
      Principal: "Volver a la página principal",
      Ayuntamiento: "¿Eres del Ayuntamiento?",
    },
